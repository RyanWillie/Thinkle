...
class ResearchTask(BaseModel):
    ...
    additional_info: str = Field(..., description="Additional information about the user to be considered")
...
class NewsStory(BaseModel):
    ...
    score: int = Field(..., description="The score of the story of relevance to the user")
...
class PlannerOutput(BaseModel):
    ...
    ScoutTasks: List[ResearchTask] = Field(..., description="The tasks to be investigated")

class PlannerState(TypedDict):
    """State for the planner agent."""
    config: ThinkleConfig
    ScoutTasks: List[ResearchTask] # Requires a reducer to add the tasks
    NewsStories: Annotated[List[NewsStory], operator.add] # Requires a reducer to add the stories
    Report: str
...
class EvaluatorOutput(BaseModel):
    ...
    NewsStories: List[NewsStory] = Field(..., description="The relevant news stories that have been identified")
    InvestigatorTasks: List[ResearchTask] = Field(..., description="The tasks to be investigated")
