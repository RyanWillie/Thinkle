...
class TestThinkleConfig:
    ...
    def test_all_sources_disabled_validation(self):
        ...
        errors = exc_info.value.errors()
        assert any(
            "at least one content source" in str(error["msg"]).lower()
            for error in errors
        )
...
class TestSpecialConfigurations:
    ...
    def test_all_valid_tones(self, tone):
        ...
        config = ThinkleConfig(
            interests=["test"], newsletter=NewsletterSettings(tone=tone)
        )
    ...
    def test_all_valid_frequencies(self, frequency):
        ...
        config = ThinkleConfig(
            interests=["test"], newsletter=NewsletterSettings(frequency=frequency)
        )
    ...
    def test_all_valid_formats(self, format_type):
        ...
        config = ThinkleConfig(
            interests=["test"], output=OutputSettings(format=format_type)
        )
